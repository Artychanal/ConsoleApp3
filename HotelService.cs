...
public class HotelService : IService<Hotel>
{
    ...
    public void Save(Hotel hotel)
    {
        ...
        {
            hotel.Id = hotels.Count > 0 ? hotels.Max(hot => hot.Id) + 1 : 1;
            hotels.Add(hotel);
        }
    ...
    public void Delete(long id)
    {
        ...
        if (hotels == null)
        {
            throw new Exception("Hotel was not found");
        }
    ...
    public List<Hotel> GetAll(ClientService.SortField sortField,
        ClientService.SortOrder sortOrder)
    {
    ...
    public List<Hotel> LoadFromFile()
    {
        if (File.Exists(FilePath))
        {
            ...
            return JsonSerializer.Deserialize<List<Hotel>>(json) ?? new
                List<Hotel>();
        }
